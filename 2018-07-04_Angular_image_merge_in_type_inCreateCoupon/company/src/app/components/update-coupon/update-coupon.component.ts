...
export class UpdateCouponComponent implements OnInit {
  ...
  { 
    ...
    if(this._coupon.type == "RESTURANTS")
      this._coupon.image = this.resturants;
    if(this._coupon.type == "ELECTRICITY")
      this._coupon.image = this.electricity;
    if(this._coupon.type == "FOOD")
      this._coupon.image = this.food;
    if(this._coupon.type == "HEALTH")
      this._coupon.image = this.health;
    if(this._coupon.type == "SPORTS")
      this._coupon.image = this.sports;
    if(this._coupon.type == "CAMPING")
      this._coupon.image = this.camping;
    if(this._coupon.type == "TRAVELLING")
      this._coupon.image = this.travelling;  
